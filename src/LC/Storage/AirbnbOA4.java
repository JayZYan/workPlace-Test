...
public class AirbnbOA4 {

    public static List<String> Battle(List<String> input){
        ...
        for(String line: input){
            ...
            if (parse[2].equals("Support")) {
                ...
                if(posMap.get(supportPos).size()==1){ // No other attack for support. 1point3acres
        ...
        for(String armyItem : resMap.keySet()){
            ...
            String str = armyItem + " " + resMap.get(armyItem);

//            sb.append(armyItem);
//            sb.append(" ");
//            sb.append(resMap.get(armyItem));
...
//        String[] input = new String[]{"A Mu Hold",
//                "B Bohemia Move Mu",
//                "C Pru Move Mu",
//        "D war Hold"};
//
...
//                "C Wa Support B"};
        ...
        input3.add("D XX Hold");
        input3.add("C DF Support B");
        input3.add("M Wa Support B");
        input3.add("G FC Move Mu");
        input3.add("D XX Hold");
        input3.add("F dd Support G");
